...
<?php
    ...
    echo ('<form name="user_config" id="user_config" action="save_config.php" onsubmit="return ValidateInput();" method="post">
           ...
           <tr align=left><td title="Enter the Gmail address from where the FalconGate alerts will be send." colspan=2>Gmail Address: <input type=text size=20 name="mailer_address" id="mailer_address" value='.$config['main']['mailer_address'].'></td></tr>
